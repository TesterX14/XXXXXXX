...
function Chloex:MakeNotify(NotifyConfig)
    ...
    task.spawn(function()
        ...
        Desc.Position = UDim2.new(0, Title.TextBounds.X + 50, 0, 0)
        Desc.Parent = Top
        ...
        Content.Size = UDim2.new(1, -20, 0, math.max(13, Content.TextBounds.Y))

        if Content.AbsoluteSize.Y < 27 then
            NotifyFrame.Size = UDim2.new(1, 0, 0, 65)
        else
            NotifyFrame.Size = UDim2.new(1, 0, 0, Content.AbsoluteSize.Y + 45)
        end
